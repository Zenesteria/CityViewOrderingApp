    ...
    return(
        <div className="flex items-center w-full h-[25vh] sm:min-h-[130px] min-h-[150px] max-h-[130px] my-2 sm:max-h-[180px] rounded-3xl bg-gradient-to-r from-white to-[rgba(255,237,233,0.1)] lg:shadow-[0_10px_40px_rgba(0,0,0,0.1)] min-w-[330px]">
            <div className="flex flex-1 h-full items-center rounded-bl-3xl rounded-tl-3xl">
                <div className="flex items-center justify-center relative h-full w-[120px] sm:w-[100px] lg:mx-auto xl:w-[120px]  drop-shadow-2xl">
                ...
                <div className="flex flex-col h-full w-fit items-center justify-center p-2 text-center min-w-[80px]">
                    <h1 className='text-[0.8rem] sm:text-[1.2rem] lg:text-[1.5rem] font-bold'>{productData.title}</h1>
                    <p className='text-gray-600 text-[0.7rem] sm:text-[0.8rem] lg:text-[1.1rem]'>{productData.desc}</p>
                </div>
                <div className="flex h-fit mx-2 xl:mx-auto min-w-[50px] justify-around items-center rounded-md sm:rounded-2xl lg:shadow-[0_15px_20px_rgba(153,43,17,0.2)]">
                    <h1 className='font-semibold'>qty : {productData.quantity}</h1>
                </div>
                <h1 className='font-bold flex-[0.5] flex items-center justify-center text-[0.8rem] lg:text-[1.2rem] mx-2 sm:mx-auto p-2 min-w-[60px]'>Total: ₦{productData.price * productData.quantity}</h1>
            </div>
